...
public class ProblemSet3 {
	...
	public static void main(String[] args) {
		ProblemSet3 pst3 = new ProblemSet3(); 
		pst3.dateFashion(8, 3); 
		pst3.fizzString("fig");
		pst3.squirrelPlay(90, false);
		pst3.fizzStringAgain(15);
		pst3.makeBricks(6, 1, 10);
		pst3.loneSum(5, 6, 5);
		pst3.luckySum(13, 8, 9);
		pst3.factorialFor(4);
		pst3.factorialWhile(4);
		pst3.isPrime(0);
	}
	...
	public void makeBricks(int small, int big, int goal) {
		...
		if (small + newBig >= goal) {
			if (goal - small == 0 || goal - newBig == 0) {
				System.out.println("YES");
			}
			else if (small + newBig == goal) {
				System.out.println("YES");
			}
			else {
				System.out.println("NO");
